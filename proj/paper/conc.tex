...
%To make these sorts of analyses more concrete we hope to describe our analyses
%from Section \ref{sec:dom:greedy-results} in terms a `game design'
%domain expert can understand.
%and described in terms a
%game design domain expert not steeped in the specifics
